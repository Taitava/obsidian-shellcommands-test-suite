...
Shell commands version: **0.19.0-beta.1**
Test date: **2023-03-11**
...
- [x] \* **[Title 2023-03-11 (incomplete) to file](obsidian://shell-commands/?vault=Shell%20commands%20test&execute=acmo3jqv6g)**
...
MODAL OUTPUT
TEXT TO TOP
File created: 2023-03-11 (incomplete).md
Date and time: 2023-03-11 19:08:48
File name: 2023-03-11 (incomplete).md
Caret paragraph: \*) These commands' output handling is done in [realtime mode](https://publish.obsidian.md/shellcommands/Output+handling/Realtime+output+handling). It should not affect the outcome, but expands testing to that output handling mode, too.
Caret position: 32:214 (line: 32, column:214)
Clipboard: TESTCLIPBOARD
File extension: with dot: .md / no dot: md
Absolute file path: V:\Lajitellut\Obsidian-tietokannat\Shell commands test\Performed tests\2023-03-11 (incomplete).md
Relative file path: Performed tests\2023-03-11 (incomplete).md
File URI: obsidian://vault/Shell%20commands%20test/Performed%20tests%2F2023-03-11%20(incomplete).md
...
Absolute new note folder path: V:\Lajitellut\Obsidian-tietokannat\Shell commands test\Performed tests
Relative new note folder path: Performed tests
Selection: TESTSELECTION
Tags: frontmatter-tag, this-should-not-appear-twice, inline-tag
Title: 2023-03-11 (incomplete)
Vault path: V:\Lajitellut\Obsidian-tietokannat\Shell commands test
...
MultilineRealtime 1: Caret position
...
Folder created: Untitled
Folder renamed from Untitled to Folder again
Folder moved from Sandbox\Folder again to Sandbox\ParentFolder\Folder again
File created: Untitled.md
File renamed from Untitled.md to Note again.md
File moved from Sandbox\ParentFolder\Note again.md to Sandbox\ParentFolder\Folder again\Note again.md
Folder moved from Sandbox\ParentFolder\Folder again\Note again.md to Sandbox\ParentFolder\NewFolder\Folder again
File moved from Sandbox\ParentFolder\Folder again\Note again.md to Sandbox\ParentFolder\NewFolder\Folder again\Note again.md
Folder deleted: NewFolder
File deleted: NewNote.md
Folder deleted: Folder again
File deleted: Note again.md
Day of week: Saturday
Prompt mandatory field: example
Prompt field with a default value: Default
Prompt optional field: 
Prompt field using variables: 2023 
