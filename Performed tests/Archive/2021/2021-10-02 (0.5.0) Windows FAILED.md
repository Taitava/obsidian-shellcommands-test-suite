...
Shell commands version: **0.5.0**
Test date and start time: **2021-10-02 17:46**
...
2. [x] Change *Notification message duration* to 1 second, execute the same command again and see that the notification message shows up, but disappears quicly.
...
"Date and time: 2021-10-02 17:49:36" 
"File name:2021-10-02 (incomplete).md" 
"Absolute file path: V:\Lajitellut\Obsidian-tietokannat\Shell commands test\Performed tests\2021-10-02 (incomplete).md" 
"Relative file path: Performed tests\2021-10-02 (incomplete).md" 
...
"Tags: #frontmatter-tag, #inline-tag" 
"Title: 2021-10-02 (incomplete)" 
