...
Shell commands version: **0.13.0**
Test date: **2022-06-28**
...
- [ ] In the settings panel, pay attention to scrolling. SC's settings panel should remember the last scroll position when reopened. Tick this checkbox if it did remember. Exception: the scroll position is forgotten when Obsidian is restarted. ==Does not work. Correct tab is remembered, but the scroll position is forgotten. I'm wondering if this is because of some update in Obsidian, because this problem did not occur in 0.13.0-beta.1 test, which was performed on an earlier version of Obsidian.==
...
MODAL OUTPUT
TEXT TO TOP
File created: 2022-06-28 (incomplete).md
Caret position: 28:23 (line: 28, column:23)
Clipboard: TESTCLIPBOARD
Date and time: 2022-06-28 12:29:59
File extension: with dot: .md / no dot: md
File name: 2022-06-28 (incomplete).md
Absolute file path: /home/jarkko/Obsidian-tietokannat/Shell commands test/Performed tests/2022-06-28 (incomplete).md
Relative file path: Performed tests/2022-06-28 (incomplete).md
...
Prompt field with a default value: Default
Prompt optional field: 
Prompt field using variables: 2022 2022-06-28 (incomplete).md
