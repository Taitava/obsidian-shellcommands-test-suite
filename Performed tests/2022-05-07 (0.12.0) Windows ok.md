...
Shell commands version: **0.12.0**
Test date: **2022-05-07**
...
MODAL OUTPUT
TEXT TO TOP
Caret position: 28:40 (line: 28, column:40)
Clipboard: TESTCLIPBOARD
Date and time: 2022-05-07 09:33:14
File extension: with dot: .md / no dot: md
File name: 2022-05-07 (incomplete).md
Absolute file path: V:\Lajitellut\Obsidian-tietokannat\Shell commands test\Performed tests\2022-05-07 (incomplete).md
Relative file path: Sandbox\TestResults.md
...
Prompt field with a default value: Default
Prompt optional field: 
Prompt field using variables: 2022 2022-05-07 (incomplete).md
