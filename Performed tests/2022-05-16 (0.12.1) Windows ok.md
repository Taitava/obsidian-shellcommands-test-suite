...
- [x] **Test output to clipboard**: After running the command, paste clipboard content here: TESTCLIPBOARD
...
MODAL OUTPUT
TEXT TO TOP
Caret position: 27:28 (line: 27, column:28)
Clipboard: TESTCLIPBOARD
Date and time: 2022-05-16 18:52:14
File extension: with dot: .md / no dot: md
File name: 2022-05-16 (incomplete).md
Absolute file path: V:\Lajitellut\Obsidian-tietokannat\Shell commands test\Performed tests\2022-05-16 (incomplete).md
Relative file path: Performed tests\2022-05-16 (incomplete).md
...
Prompt field with a default value: Default
Prompt optional field: 
Prompt field using variables: 2022 2022-05-16 (incomplete).md
