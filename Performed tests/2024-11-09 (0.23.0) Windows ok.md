...
- File/folder menu items:
	- [x] Right-click _Content note_ file in left navigation, and then click **Test file menu event variables**. Check that an OK result appears in [[TestResults.md]].
...
8. [x] After submitting the values, [[TestResults.md]] will contain a table showing test results. Tick this checkbox, if you see the text **ALL PASSED**.
...
WSL executed.
```
- [x] Check that the folder path on the first line begins with `/mnt/`. If not, _path translation_ does not work.
- [x] Check that `You wanted to output this:` is followed by the value you submitted in the prompt.
- [x] Check that `+-*/` appears **without** escaping characters.
...
Variable escaping should use unix style escaping: +-*/*
```
- [x] Check that the folder path on the second line begins with `/v/` (`v` can be a different character). If not, _path translation_ does not work.
- [x] Check that `+-*/*` appears **without** escaping characters.
  - This would be incorrect: `` `+`-`*`/`* `` If this appears, then the custom shell uses a wrong escaping character.
...
MODAL OUTPUT
TEXT TO TOP
Caret position: 33:42 (line: 33, column:42)
...
Builtin variable's global default value: This is a global default value for {{event_title}}.Realtime 1: Caret position
...
| `{{date:YYYY-MM-DD HH:mm:ss}}` | ok | <small>2024-11-09 11:08:47</small> | <small>Either `2024-11-09 11:08:48` or `2024-11-09 11:08:47`</small> |
...
| `{{file_path:absolute}}` | ok | <small>V:\Obsidian-tietokannat\Shell commands test\Performed tests\2024-11-09 (incomplete).md</small> | <small>V:\Obsidian-tietokannat\Shell commands test\Performed tests\2024-11-09 (incomplete).md</small> |
...
| `{{folder_path:absolute}}` | ok | <small>V:\Obsidian-tietokannat\Shell commands test\Performed tests</small> | <small>V:\Obsidian-tietokannat\Shell commands test\Performed tests</small> |
...
| `{{new_note_folder_path:absolute}}` | ok | <small>V:\Obsidian-tietokannat\Shell commands test\Performed tests</small> | <small>V:\Obsidian-tietokannat\Shell commands test\Performed tests</small> |
...
| `{{vault_path}}` | ok | <small>V:\Obsidian-tietokannat\Shell commands test</small> | <small>V:\Obsidian-tietokannat\Shell commands test</small> |
| `{{workspace}}` | ok | <small>MyWorkspace</small> | <small>MyWorkspace</small> |
| `{{yaml_content:no-dashes}}` | ok | <small># Do not change these values during testing.<br>tags:<br>  - frontmatter-tag<br>  - this-should-not-appear-twice<br>yaml_test1:<br>  first_item: "first value"<br>  middle_item:<br>    inner_item: "inner value"<br>  last_item: "last value"<br>yaml_test2:<br>  - first-item<br>  - second-item<br>  - last-item</small> | <small># Do not change these values during testing.<br>tags:<br>  - frontmatter-tag<br>  - this-should-not-appear-twice<br>yaml_test1:<br>  first_item: "first value"<br>  middle_item:<br>    inner_item: "inner value"<br>  last_item: "last value"<br>yaml_test2:<br>  - first-item<br>  - second-item<br>  - last-item</small> |
| `{{yaml_content:with-dashes}}` | ok | <small>---<br># Do not change these values during testing.<br>tags:<br>  - frontmatter-tag<br>  - this-should-not-appear-twice<br>yaml_test1:<br>  first_item: "first value"<br>  middle_item:<br>    inner_item: "inner value"<br>  last_item: "last value"<br>yaml_test2:<br>  - first-item<br>  - second-item<br>  - last-item<br>---</small> | <small>---<br># Do not change these values during testing.<br>tags:<br>  - frontmatter-tag<br>  - this-should-not-appear-twice<br>yaml_test1:<br>  first_item: "first value"<br>  middle_item:<br>    inner_item: "inner value"<br>  last_item: "last value"<br>yaml_test2:<br>  - first-item<br>  - second-item<br>  - last-item<br>---</small> |
...
| Escaping test | ok | <small>>,.-;:�+��!'"#�%&/()\|=?`@`�$�{[]}\\�^~*���*</small> | <small>>,.-;:�+��!'"#�%&/()\|=?`@`�$�{[]}\\�^~*���*</small> |
| **Summary:** | **ALL&nbsp;PASSED** |||

Working directory: `V:\Obsidian-tietokannat\Shell commands test\Sandbox`
Working directory: `V:\Obsidian-tietokannat\Shell commands test`
...
 
 PSCore version: 7
Event debounce test at :11:19:36
Event debounce test at :11:19:40
Event debounce test at :11:19:50
Event debounce test at :11:19:56
Event debounce test at :11:20:02
Event debounce test at :11:20:31
Event debounce test at :11:21:20
Event debounce test at :11:21:24
Event debounce test at :11:21:27
Event debounce test at :11:21:30
Event debounce test at :11:21:33
...
| `{{_multiline_field}}` | ok | <small>Line1<br>Line2</small> | <small>Line1<br>Line2</small> |
...
> [!Summary] WSL test
> Executing WSL in `/mnt/v/Obsidian-tietokannat/Shell commands test`:
> Hello from WSL!
> You wanted to output this: Jarkko
> Variable escaping should use unix style escaping: +-*/*
> WSL executed.

Hello from MinGW-w64!
Vault path: `/v/Obsidian-tietokannat/Shell commands test`
Variable escaping should use unix style escaping: +-*/*
"'Obsidian quits' event triggered." 
"'Obsidian quits' event triggered." 
