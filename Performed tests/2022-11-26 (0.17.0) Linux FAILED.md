...
Shell commands version: **0.17.0**
Test date: **2022-11-26**
...
- [x] \* **[Title 2022-11-26 (incomplete) to file](obsidian://shell-commands/?vault=Shell%20commands%20test&execute=acmo3jqv6g)**
...
- [ ] **Test {{file content}}**: Open [[Welcome.md]] before executing this! Otherwise you'll get an error message saying that the shell command is too long. You should see the file's content **with YAML**. ==Line breaks do not work correctly.==
- [ ] **Test {{note content}}**: Open [[Welcome.md]] before executing this! Otherwise you'll get an error message saying that the shell command is too long. You should see the file's content **without YAML**. ==Line breaks do not work correctly.==
...
MODAL OUTPUT
TEXT TO TOP
File created: 2022-11-26 (incomplete).md
Date and time: 2022-11-26 19:01:02
Date and time: 2022-11-26 19:01:10
File name: 2022-11-26 (incomplete).md
...
Caret position: 29:25 (line: 29, column:25)
Clipboard: TESTCLIPBOARD
File extension: with dot: .md / no dot: md
Absolute file path: /home/jarkko/Obsidian-tietokannat/Shell commands test/Performed tests/2022-11-26 (incomplete).md
Relative file path: Performed tests/2022-11-26 (incomplete).md
File URI: MODAL OUTPUT
obsidian://vault/Shell%20commands%20test/Performed%20tests%2F2022-11-26%20(incomplete).md
...
New note folder name: Performed testsRealtime 1: Caret position
...
Realtime 4: Bottom
Realtime 5: Bottom
File created: 2022-11-26 (incomplete) 1.md
File renamed from 2022-11-26 (incomplete) 1.md to 2022-11-26 (incomplete) BACKUP.md
...
File renamed from Untitled.md to New note.md
Folder created: Untitled
Folder renamed from Untitled to New folder
File moved from Sandbox/New note.md to Sandbox/New folder/New note.md
Folder created: Untitled
Folder renamed from Untitled to Parent folder
File moved from Sandbox/New folder/New note.md to Sandbox/Parent folder/New folder/New note.md
Folder deleted: New folder
File deleted: New note.md
Folder deleted: Parent folder
Day of week: Saturday
Prompt mandatory field: example
Prompt field with a default value: Default
Prompt optional field: 
Prompt field using variables: 2022 2022-11-26 (incomplete).md
Custom variable 1: Hello
Custom variable 2: world!
File created: 2022-11-26 (incomplete) 1.md
File renamed from 2022-11-26 (incomplete) 1.md to 2022-11-26 (incomplete) 2.md
File renamed from 2022-11-26 (incomplete) 2.md to 2022-11-26 (incomplete) BACKUP 2.md
