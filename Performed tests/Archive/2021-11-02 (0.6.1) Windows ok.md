...
Shell commands version: **0.6.1**
Test date and start time: **2021-11-02 18:06**
...
- [x] **Title 2021-11-02 (incomplete) to file**
...
- [x] **Vault path {{vault_path}} to file**
- [x] **Workspace {{workspace}} to file**
- [x] **Character encoding test**: This outputs *Test non-ASCII characters: Å Ä Ö* to *TestResults.md*. **Check that Å Ä Ö show up correctly in the file.** If you see something strange (e.g. �), the test is failed and you should not tick the checkbox in this test report. ==For some reason Å Ä Ö characters have started working on Windows.==
...
- [x] **Test output to clipboard**: After running the command, paste clipboard content here: 
...
2. [x] Create a new shell command. This can be something simple with one variable, like: `echo 2021-11-02 (incomplete)`. The command does not need to actually do anything. No need to assign an alias (yet).
...
"Date and time: 2021-11-02 18:42:22" 
"File name: 2021-11-02 (incomplete).md" 
"Absolute file path: V:\Lajitellut\Obsidian-tietokannat\Shell commands test\Performed tests\2021-11-02 (incomplete).md" 
"Relative file path: Performed tests\2021-11-02 (incomplete).md" 
