...
Shell commands version: **0.15.0**
Test date: **2022-08-20**
...
- [x] **[Test output to clipboard](obsidian://shell-commands/?vault=Shell%20commands%20test&execute=5lk1z1h1ds)**: After running the command, paste clipboard content here: 
...
MODAL OUTPUT
TEXT TO TOP
File created: 2022-08-20 (incomplete).md
Caret position: 28:52 (line: 28, column:52)
Clipboard: TESTCLIPBOARD
Date and time: 2022-08-20 19:09:15
File extension: with dot: .md / no dot: md
File name: 2022-08-20 (incomplete).md
Absolute file path: /home/jarkko/Obsidian-tietokannat/Shell commands test/Performed tests/2022-08-20 (incomplete).md
Relative file path: Performed tests/2022-08-20 (incomplete).md
File URI: obsidian://vault/Shell%20commands%20test/Performed%20tests%2F2022-08-20%20(incomplete).md
