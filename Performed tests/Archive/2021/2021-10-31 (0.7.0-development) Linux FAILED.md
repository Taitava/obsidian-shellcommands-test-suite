...
Test date and start time: **2021-10-31 11:39**
...
- [x] **Test output insertion**:
	...
	- [x] Select some word in this Text output test and execute the command to see how *replacing* works.
...
- Linux:
	- [x] **Test Linux shell: Bash**: Uses explicitly Bash and it should output an absolute path to a Bash binary file.
	- [x] **Test Linux shell: Zsh**: Uses explicitly Zsh (Z shell) and it should output an absolute path to a Zsh binary file.
...
Date and time: 2021-10-31 12:57:58
File name: 2021-10-31 (incomplete).md
Absolute file path: /home/jarkko/Obsidian-tietokannat/Shell commands test/Performed tests/2021-10-31 (incomplete).md
Relative file path: Performed tests/2021-10-31 (incomplete).md
