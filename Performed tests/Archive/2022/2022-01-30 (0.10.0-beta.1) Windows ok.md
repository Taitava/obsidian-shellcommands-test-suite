...
Shell commands version: **0.10.0-beta.1**
Test date: **2022-01-30**
...
MODAL OUTPUT
TEXT TO TOP
Caret position: 27:52 (line: 27, column:52)
Clipboard: TESTCLIPBOARD
Date and time: 2022-01-30 08:48:47
File extension: with dot: 
.md / no dot: md
File name: 2022-01-30 (incomplete).md
Absolute file path: V:\Lajitellut\Obsidian-tietokannat\Shell commands test\Performed tests\2022-01-30 (incomplete).md
Relative file path: Performed tests\2022-01-30 (incomplete).md
