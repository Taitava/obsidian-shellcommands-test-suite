...
- [x] **[Test {{file content}}](obsidian://shell-commands/?vault=Shell%20commands%20test&execute=au049jz2sy)**: You should see the current file's content **with YAML**. (This test and the similar one below uses `stdin` to pass the variable content to shell, so the `stdin` fcoeature gets tested, too).
...
==Passed, but _Escaping test_ shows corrupted characters. I believe it's an output problem (because python received the characters correctly), but can't understand, where the problem arises from.==
...
MODAL OUTPUT
TEXT TO TOP
Date and time: 2023-11-28 17:31:48
File name: 2023-11-28 (incomplete).mdMODAL OUTPUT

Caret position: 33:136 (line: 33, column:136)
...
| `{{date:YYYY-MM-DD HH:mm:ss}}` | ok | <small>2023-11-28 17:50:19</small> | <small>Either `2023-11-28 17:50:19` or `2023-11-28 17:50:18`</small> |
| `{{file_extension:no-dot}}` | ok | <small>md</small> | <small>md</small> |
| `{{file_extension:with-dot}}` | ok | <small>.md</small> | <small>.md</small> |
| `{{file_name}}` | ok | <small>2023-11-28 (incomplete).md</small> | <small>2023-11-28 (incomplete).md</small> |
| `{{file_path:absolute}}` | ok | <small>V:\Obsidian-tietokannat\Shell commands test\Performed tests\2023-11-28 (incomplete).md</small> | <small>V:\Obsidian-tietokannat\Shell commands test\Performed tests\2023-11-28 (incomplete).md</small> |
| `{{file_path:relative}}` | ok | <small>Performed tests\2023-11-28 (incomplete).md</small> | <small>Performed tests\2023-11-28 (incomplete).md</small> |
| `{{file_uri}}` | ok | <small>obsidian://vault/Shell%20commands%20test/Performed%20tests%2F2023-11-28%20(incomplete).md</small> | <small>obsidian://vault/Shell%20commands%20test/Performed%20tests%2F2023-11-28%20(incomplete).md</small> |
...
| `{{title}}` | ok | <small>2023-11-28 (incomplete)</small> | <small>2023-11-28 (incomplete)</small> |
...
| `{{yaml_content:no-dashes}}` | ok | <small># Do not change these values during testing.<br>test_suite_version: 0.20.0<br>tags:<br>  - frontmatter-tag<br>  - this-should-not-appear-twice<br>yaml_test1:<br>  first_item: "first value"<br>  middle_item:<br>    inner_item: "inner value"<br>  last_item: "last value"<br>yaml_test2:<br>  - first-item<br>  - second-item<br>  - last-item</small> | <small># Do not change these values during testing.<br>test_suite_version: 0.20.0<br>tags:<br>  - frontmatter-tag<br>  - this-should-not-appear-twice<br>yaml_test1:<br>  first_item: "first value"<br>  middle_item:<br>    inner_item: "inner value"<br>  last_item: "last value"<br>yaml_test2:<br>  - first-item<br>  - second-item<br>  - last-item</small> |
| `{{yaml_content:with-dashes}}` | ok | <small>---<br># Do not change these values during testing.<br>test_suite_version: 0.20.0<br>tags:<br>  - frontmatter-tag<br>  - this-should-not-appear-twice<br>yaml_test1:<br>  first_item: "first value"<br>  middle_item:<br>    inner_item: "inner value"<br>  last_item: "last value"<br>yaml_test2:<br>  - first-item<br>  - second-item<br>  - last-item<br>---</small> | <small>---<br># Do not change these values during testing.<br>test_suite_version: 0.20.0<br>tags:<br>  - frontmatter-tag<br>  - this-should-not-appear-twice<br>yaml_test1:<br>  first_item: "first value"<br>  middle_item:<br>    inner_item: "inner value"<br>  last_item: "last value"<br>yaml_test2:<br>  - first-item<br>  - second-item<br>  - last-item<br>---</small> |
...
Prompt field with a default value: Default
Prompt optional field: 
Prompt field using variables: 2023 2023-11-28 (incomplete).md
...
Hello from WSL!
You wanted to output this: whatever
Variable escaping should use unix style escaping: +-*/*
WSL executed.
Hello from MinGW-w64!
