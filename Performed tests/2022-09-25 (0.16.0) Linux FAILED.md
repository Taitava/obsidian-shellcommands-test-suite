...
- [ ] In the settings panel, pay attention to scrolling. SC's settings panel should remember the last scroll position when reopened. Tick this checkbox if it did remember. Exception: the scroll position is forgotten when Obsidian is restarted. ==Same issue as with the [[2022-09-25 (0.16.0) Windows FAILED|Windows test]].==
...
Date and time: 2022-09-25 15:07:38
File extension: with dot: .md / no dot: md
File name: 2022-09-25 (incomplete).md
Absolute file path: /home/jarkko/Obsidian-tietokannat/Shell commands test/Performed tests/2022-09-25 (incomplete).md
...
Relative new notMODAL OUTPUT
e folder path: Performed tests
