...
Shell commands version: **0.12.0-beta.1**
Test date: **2022-04-15**
...
1. [x] The prompt's description shows a week day name instead of `Friday`.
2. [x] The shell command preview text shows a week day name instead of `Friday`.
...
MODAL OUTPUT
TEXT TO TOP
Caret position: 22:40 (line: 22, column:40)
Clipboard: TESTCLIPBOARD
Date and time: 2022-04-15 09:02:26
File extension: with dot: 
.md / no dot: md
File name: 2022-04-15 (incomplete).md
Absolute file path: V:\Lajitellut\Obsidian-tietokannat\Shell commands test\Performed tests\2022-04-15 (incomplete).md
Relative file path: Performed tests\2022-04-15 (incomplete).md
...
Prompt field with a default value: Default
Prompt optional field: 
Prompt field using variables: 2022 2022-04-15 (incomplete).md
