...
MODAL OUTPUT
TEXT TO TOP
Date and time: 2023-01-06 14:08:24
...
Caret position: 29:44 (line: 29, column:44)
Clipboard: TESTCLIPBOARD
File extension: with dot: .md / no dot: md
Absolute file path: V:\Lajitellut\Obsidian-tietokannat\Shell commands test\Performed tests\2023-01-06 (incomplete).md
...
Absolute new note folder path: V:\Lajitellut\Obsidian-tietokannat\Shell commands test\Performed testsMODAL OUTPUT
...
File deleted: A file that did not exist before.mdRealtime 1: Caret position
...
Realtime 4: Bottom
Realtime 5: Bottom
File created: 2023-01-06 (incomplete).md~
File deleted: 2023-01-06 (incomplete).md~
