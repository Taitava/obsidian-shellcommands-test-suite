...
Operating system: **Xubuntu 20.04.3**
Obsidian version: **0.12.15**
Shell commands version: **0.4.0**
Test date and start time: **2021-09-26 13:08**
...
- [ ] *Absolute file path {{file_path:absolute}} to file* ==Missing leading /==
- [x] *Relative file path {{file_path:relative}} to file*
- [x] *Folder name {{folder_name}} to file*
- [ ] *Absolute folder path {{folder_path:absolute}} to file* ==Missing leading /==
...
- [x] *Date and time {{date:YYYY-MM-DD HH:mm:ss} } to file*
- [x] *File name {{file_name}} to file*
- [ ] *Absolute file path {{file_path:absolute}} to file*: If you are on **Mac or Linux**, please ensure that the path starts with `/`, e.g. `/Users/.../SomeFile.md`. If it's without a leading `/` (e.g. `Users/.../SomeFile.md`), then there is a bug. Add a comment here and leave the checkbox unchecked. ==Missing leading /==
- [x] *Relative file path {{file_path:relative}} to file*
- [x] *Folder name {{folder_name}} to file*
- [ ] *Absolute folder path {{folder_path:absolute}} to file*: **Same check** as with *Absolute file path* above. ==Missing leading /==
- [x] *Relative folder path {{folder_path:relative}} to file*
- [x] *Selection {{selection}} to file*: (You can select this text: TESTSELECTION).
- [x] *Title {{title}} to file*
- [x] *Vault path {{vault_path}} to file*
...
3. [ ] Open up command palette again, type *execute* and check quickly that all commands that start with *Shell commands: Execute:* have variable names visible, meaning that `{{`/`}}` structures should be visible. ==Failed: variables have still values visible.==
...
Date and time: 2021-09-26 13:23:15
File name:2021-09-26 (incomplete).md
Absolute file path: home/jarkko/Obsidian-tietokannat/Shell commands test/Performed tests/2021-09-26 (incomplete).md
Absolute folder path: home/jarkko/Obsidian-tietokannat/Shell commands test/Performed tests
Relative file path: Performed tests/2021-09-26 (incomplete).md
Relative folder path: Performed tests
Folder name: Performed tests
Selection: TESTSELECTION
Title: 2021-09-26 (incomplete)
